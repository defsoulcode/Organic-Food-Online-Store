...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($categories) {
            ...
            return redirect()->route('categories.index')->with('errors', 'Category failed to add');
        }
    }
    ...
    public function destroy($id)
    {
        $category = Category::findOrFail($id);
        $category->delete();
        return redirect()->route('categories.index')->with('errors', 'Category added successfully');
    }
