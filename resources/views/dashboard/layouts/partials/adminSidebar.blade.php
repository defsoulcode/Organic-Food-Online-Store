    ...
    <li class="nav-item">
        ...
        <div id="master-data" class="collapse {{ isset($sbMaster) && $sbMaster === true ? 'show' : '' }}"
            ...
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item {{ isset($sbActive) && $sbActive === 'data.product' ? 'active' : '' }}"
                    href="{{ route('product.index') }}">Product</a>
                <a class="collapse-item {{ isset($sbActive) && $sbActive === 'data.categories' ? 'active' : '' }}"
                    href="{{ route('categories.index') }}">Categories</a>
                <a class="collapse-item {{ isset($sbActive) && $sbActive === 'data.distribut' ? 'active' : '' }}"
                    href="{{ route('distribut.index') }}">Distribut</a>
                <!--active class-->
