            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-dark">{{ $product->count() . " Product" }}</div>
                    </div>
                    <div class="col-auto">
        ...
        <div class="card border-left-warning shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="font-weight-bold text-dark text-uppercase mb-1">
                            <a href="{{ route('distribut.index') }}">Data Distribut</a>
                        </div>
                        <div class="h5 mb-0 font-weight-bold text-dark">{{ $distribut->count() . " Distribut" }}</div>
                    </div>
                    <div class="col-auto">
