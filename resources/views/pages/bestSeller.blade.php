                    ...
                    <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                            ...
                            @foreach ($products as $data)
                                <div class="col-lg mb-5">
                                    <div class="card h-100 border-0 shadow-lg">
                                        <!-- Product image-->
                                        @if ($data->image)
                                            <img class="card-img-top" src="{{ asset('storage/' . $data->image) }}" alt=""
                                                style="width: 100%; height: 100%; object-fit: cover;" />
                                        @else
                                            <img class="card-img-top" src="{{ asset('assets/images/cover-404.jpg') }}" alt=""
                                                style="width: 100%; height: 100%; object-fit: cover;" />
                                        @endif
                                        <!-- Product details-->
                                        <div class="card-body">
                                            <div class="text-center">
                                                <!-- Product name-->
                                                <h6 class="fw-semibold">{{ $data->name_prod }}</h6>
                                                <!-- Product Rating-->
                                                <p>
                                                ...
                                                <!-- Product price-->
                                                <span class="fw-bolder badge text-bg-success fs-6">@currency($data->price)</span>
                                            </div>
                                        </div>
                                        <!-- Product button cart-->
                                                ...
                                                <div class="col-md-7">
                                                    <form action="{{ route('cart.store') }}" method="POST">
                                                        ...
                                                        <input type="hidden" name="product_id" value="{{ $data->id }}" />
                                                            <input type="number" name="quantity" max="{{ $data->stock }}" min="0" 
                                                                class="form-control text-center" value="{{ ($data->stock > 0) ? 1 : 0 }}" />
                                                </div>
                                                <div class="col-md-5">
                        ...
                        @else
                            <div class="col-md-4 mb-5">
                                <h3 class="text-center fw-normal mb-5 my-5 m">Product is Not Found!</h3>
                            </div>
                        @endif
                    </div>
                </div>
